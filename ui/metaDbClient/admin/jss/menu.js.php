...
<?php
   ...
   while ($row = mysql_fetch_array($ret, MYSQL_ASSOC)) 
   {
		...
		while ($row2 = mysql_fetch_array($ret2, MYSQL_ASSOC))
		{
			...
			//echo "oCMenu.makeMenu('js_menu".$row2['id']."_edit','js_menu1_".$row2['id']."','".getMessage('navigation_list')."','controller.php?p_action=list_instances&amp;p_class_id=".$row2['id']."','','120',0)"."\n";
			//echo "oCMenu.makeMenu('js_menu".$row2['id']."_new','js_menu1_".$row2['id']."','".getMessage('navigation_new')."','controller.php?p_action=new_instance&amp;p_class_id=".$row2['id']."','','120',0)"."\n";
