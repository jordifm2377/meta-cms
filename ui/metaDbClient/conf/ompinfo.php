 ...
 **/
		...
		define("dbuser","root");
		define("dbpass",'1234');
		define("dbname","testcms");

		define("ERROR_LEVEL",7);
		define("DIR_APLI", "/Users/jordi/workspace/git/cms/meta-cms/ui/metaDbClient");
		define("DIR_APLI_ADMIN", "/Users/jordi/workspace/git/cms/meta-cms/ui/metaDbClient");
		define("DOMAIN_SERVER","testcms.tst");
		...
		define("URL_APLI","http://www.testcms.tst");
	...
	function get_db_handler() {
		...
		if (!$dbh) {
			...
			$proves = "set global sql_mode='STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,E‌​RROR_FOR_DIVISION_BY‌​_ZERO,NO_AUTO_CREATE‌​_USER,NO_ENGINE_SUBS‌​TITUTION';";
			$ret = mysql_query($proves, $dbh);
			$proves = "set session sql_mode='STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';";
			$ret = mysql_query($proves, $dbh);
			return $dbh;
		}
	}
